...
function __fish_nv_needs_command
    not __fish_seen_subcommand_from install use update remove rollback status help
end
...
complete -c nv -n __fish_nv_needs_command -a remove -d 'Remove installed channels'
...
complete -c nv -n '__fish_seen_subcommand_from install use update remove rollback; and not __fish_seen_subcommand_from stable nightly' -a stable -d 'Stable Neovim'
complete -c nv -n '__fish_seen_subcommand_from install use update remove rollback; and not __fish_seen_subcommand_from stable nightly' -a nightly -d 'Nightly Neovim'
